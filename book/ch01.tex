...
\section{Overview}
\label{sec:01:1}
In our discussion of policies so far we dealt with the modifications ${Creation, Endorsement, Renewal}$. To this set we now
add the modifications ${Cancellation, Reinstatement}$. These new modifications are similiar to modifications we already
...
\import{ch01/}{CancellationCtx1-sa.tex}
...
\import{ch01/}{CancellationMch1-sa.tex}

\section{Liquid Calculations}
\label{sec:01:2}

\import{ch01/}{CancellationCalculations-sa.tex}
