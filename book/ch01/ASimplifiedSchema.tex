...
simplest is a set of $(Fields, Type)$ tuples. These $(Field, Type)$ tuples define the data that are 
valid attributes of an instance of a $Product$. A $Policy$ is then an instance of this $Product$ definition.
