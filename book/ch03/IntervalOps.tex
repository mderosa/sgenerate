...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Since almost every object in the framework is an interval (characteristics,
 fees,
 \ensuremath{holdbacks}, policies, modifications) making computations in
 framework code is facilitated
 by a fundamental set of predicate combinators over intervals. The
 fundamental interval
 combinators sufficient for all interval computations at \ensuremath{Socotra}
 are listedbelow. Most
...
\begin{lcom}{7.5}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 There are three inverval functions which are the fundamental combinators on
 which all
 interval functions are based. These are:
 (1) subtract: \ensuremath{Interval \.{\rightarrow} Interval \.{\rightarrow}}
 Set \ensuremath{Interval}, returns the parts of the first interval
 that do not overlap with the second interval. And will be a set of
 cardinality between
 0 and 2.
 (2) intersect: \ensuremath{Interval \.{\rightarrow} Interval
 \.{\rightarrow}} Set \ensuremath{Interval}, returns the part of the first and
 second intervals that overlap. And will be a set of cardinality between 0
 and 1.
 (3) extend: \ensuremath{Interval \.{\rightarrow} Interval \.{\rightarrow}
 Interval}, returns a single interval that minimally
 contains the input intervals.
\end{cpar}%
\end{lcom}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 02 13:21:29 \ensuremath{PDT} 2021 by \ensuremath{marco
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Wed}
 \ensuremath{Mar} 31 10:48:32 \ensuremath{PDT} 2021 by \ensuremath{ASUS
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon}
 \ensuremath{Dec} 28 09:50:41 \ensuremath{PST} 2020 by \ensuremath{ASUS
}%
\end{cpar}%
\end{lcom}%
\end{document}
