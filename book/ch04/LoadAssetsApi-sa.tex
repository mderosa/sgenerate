...
\FunctionTok{\{}
    \ErrorTok{assets}\FunctionTok{:\{}
        \ErrorTok{config.json}\FunctionTok{:} \FunctionTok{\{}\ErrorTok{timezone}\FunctionTok{:} \StringTok{"America/Los_Angeles"}\FunctionTok{,} \ErrorTok{currency}\FunctionTok{:} \StringTok{"USD"}\FunctionTok{,} \ErrorTok{improvedRating}\FunctionTok{:} \KeywordTok{true}\FunctionTok{\}}\StringTok{",}
\StringTok{        security/roles.json: \{underwriter1: "}\ErrorTok{Underwriter} \ErrorTok{Level} \DecValTok{1}\StringTok{", underwriter2: "}\ErrorTok{Underwriter} \ErrorTok{Level} \DecValTok{2}\StringTok{"\},}
\StringTok{        ...}
\StringTok{    \},}
\StringTok{    recreate: false}
\StringTok{\}}
